...
public struct HTML: PageElement {
  ...
  public init(
    type: HTMLThemeType = .auto,
    @HTMLRootElementBuilder contents: () -> [HTMLRootElement]
  ) {
    self.type = type
  ...
  public func render(context: PublishingContext) -> String {
    ...
    output += "<html lang=\"\(context.site.language.rawValue)\" data-bs-theme=\"\(type.rawValue)\"\(attributes.description)>"
